package com.example.web4_2.models;
...
public class User {
    ...
    private List<altPoint> points;


    public User(String name, String password) {
        this.setaltPoints(new ArrayList<>());
    ...
    public List<altPoint> getaltPoints() {
        return points;
    }

    public String getaltPointsAsJson() {
        StringBuilder jsonBuilder = new StringBuilder("[");

        for (int i = 0; i < points.size(); i++) {
            altPoint point = points.get(i);
            jsonBuilder.append("{")
    ...
    public void setaltPoints(List<altPoint> points) {
        this.points = points;
    }
}
